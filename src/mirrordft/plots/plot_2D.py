...
if path_stamp is not None: 
    ...
    if scf_compare:
        ...
        im1 = ax1.imshow(external_potential.reshape(N, N), cmap='plasma')
        ...
        im3 = ax3.imshow(density_md.reshape(N, N), cmap='viridis')
